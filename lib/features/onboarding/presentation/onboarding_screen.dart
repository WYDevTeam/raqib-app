    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(16),
          border: isPrimary ? null : Border.all(color: const Color(0xFFEFEFEF)),
          boxShadow: isPrimary 
        ...
        child: Row(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color: isPrimary ? Colors.white.withValues(alpha: 0.2) : colorScheme.primary.withValues(alpha: 0.1),
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: Theme.of(context).textTheme.bodySmall?.copyWith(
                      color: isPrimary ? Colors.white.withValues(alpha: 0.8) : AppTheme.textSecondary,
                    ),
                  ),
                ],
              ),
            ...
            Icon(
              Icons.chevron_right,
              color: isPrimary ? Colors.white : AppTheme.textDisabled,
            ),
          ],
        ),
      ),
